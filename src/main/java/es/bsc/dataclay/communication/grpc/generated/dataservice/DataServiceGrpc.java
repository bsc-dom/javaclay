...
public final class DataServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<es.bsc.dataclay.communication.grpc.messages.dataservice.DataserviceMessages.NewReplicaRequest,
      es.bsc.dataclay.communication.grpc.messages.common.CommonMessages.ExceptionInfo> getNewReplicaMethod;
  ...
  public static io.grpc.MethodDescriptor<es.bsc.dataclay.communication.grpc.messages.dataservice.DataserviceMessages.NewReplicaRequest,
      es.bsc.dataclay.communication.grpc.messages.common.CommonMessages.ExceptionInfo> getNewReplicaMethod() {
    io.grpc.MethodDescriptor<es.bsc.dataclay.communication.grpc.messages.dataservice.DataserviceMessages.NewReplicaRequest, es.bsc.dataclay.communication.grpc.messages.common.CommonMessages.ExceptionInfo> getNewReplicaMethod;
    if ((getNewReplicaMethod = DataServiceGrpc.getNewReplicaMethod) == null) {
      synchronized (DataServiceGrpc.class) {
        if ((getNewReplicaMethod = DataServiceGrpc.getNewReplicaMethod) == null) {
          DataServiceGrpc.getNewReplicaMethod = getNewReplicaMethod =
              io.grpc.MethodDescriptor.<es.bsc.dataclay.communication.grpc.messages.dataservice.DataserviceMessages.NewReplicaRequest, es.bsc.dataclay.communication.grpc.messages.common.CommonMessages.ExceptionInfo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static final class DataServiceBlockingStub extends io.grpc.stub.AbstractStub<DataServiceBlockingStub> {
    ...
    /**
     */
    public es.bsc.dataclay.communication.grpc.messages.common.CommonMessages.ExceptionInfo newReplica(es.bsc.dataclay.communication.grpc.messages.dataservice.DataserviceMessages.NewReplicaRequest request) {
      return blockingUnaryCall(
  ...
  public static final class DataServiceFutureStub extends io.grpc.stub.AbstractStub<DataServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<es.bsc.dataclay.communication.grpc.messages.common.CommonMessages.ExceptionInfo> newReplica(
  ...
  private static final int METHODID_EXISTS = 22;
  private static final int METHODID_STORE_TO_DB = 23;
  private static final int METHODID_GET_FROM_DB = 24;
  private static final int METHODID_UPDATE_TO_DB = 25;
  private static final int METHODID_DELETE_TO_DB = 26;
  private static final int METHODID_EXISTS_IN_DB = 27;
  private static final int METHODID_CLEAN_EXECUTION_CLASS_DIRECTORY = 28;
  private static final int METHODID_CLOSE_DB_HANDLER = 29;
  private static final int METHODID_SHUT_DOWN = 30;
  private static final int METHODID_DISCONNECT_FROM_OTHERS = 31;
  private static final int METHODID_REGISTER_PENDING_OBJECTS = 32;
  private static final int METHODID_CLEAN_CACHES = 33;
  private static final int METHODID_ACTIVATE_TRACING = 34;
  private static final int METHODID_DEACTIVATE_TRACING = 35;
  private static final int METHODID_GET_TRACES = 36;
  private static final int METHODID_CLOSE_SESSION_IN_DS = 37;
  private static final int METHODID_UPDATE_REFS = 38;
  private static final int METHODID_GET_RETAINED_REFERENCES = 39;

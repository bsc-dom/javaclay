...
/**
 * @file ExecutionEnvironmentID.java
 * @date May 23, 2013
 */
...
public class ExecutionEnvironmentID extends ID implements BackendID {
	...
	/**
	 * Constructs a new ExecutionEnvironmentID with the UUID provided
	 * @param uuid
	 *            Universal ID of the new ExecutionEnvironmentID
	 * @see ID(UUID)
	 */
	public ExecutionEnvironmentID(final UUID uuid) {
		super.setId(uuid);
	}
	 ...
	 */
	public ExecutionEnvironmentID(final String uuidStr) {
		if (uuidStr == null) {
			super.setId(UUID.randomUUID());
		} else {

...
public final class MetaClassID extends ID {

	/**
	 * MetaClassID constructor
	 ...
	 */
	public MetaClassID(final String uuidStr) {
		if (uuidStr == null) {
			super.setId(UUID.randomUUID());
		} else {
	...
	/**
	 * Constructs a new MetaClassID with the UUID provided
	 * @param uuid
	 *            Universal ID of the new MetaClassID
	 * @see ID(UUID)
	 */
	public MetaClassID(final UUID uuid) {
		super.setId(uuid);
	}

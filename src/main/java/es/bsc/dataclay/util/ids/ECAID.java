...
/** This class represents Event listener ID. */
public final class ECAID extends ID {
	 ...
	 */
	public ECAID(final String uuidStr) {
		if (uuidStr == null) {
			super.setId(UUID.randomUUID());
		} else {

...
// / This class represents an Account identification.
...
public final class AccountID extends ID {
	...
	/**
	 * Constructs a new AccountID with the UUID provided
	 * @param uuid
	 *            Universal ID of the new AccountID
	 * @see ID(UUID)
	 */
	public AccountID(final UUID uuid) {
		super.setId(uuid);
	}
	 ...
	 */
	public AccountID(final String uuidStr) {
		if (uuidStr == null) {
			super.setId(UUID.randomUUID());
		} else {

...
public final class CharacterWrapper extends DataClayJavaWrapper {
	...
	public void serialize(final DataClayByteBuffer dcBuffer, final boolean ignoreUserTypes,
		...
		if (DataClaySerializationLib.DEBUG_ENABLED) { 
			DataClaySerializationLib.LOGGER.debug("[Serialization] --> Serialized Character: data=" + charObject + ", writerIndex=" + dcBuffer.writerIndex());
		}
	}
	...
	public void deserialize(final DataClayByteBuffer dcBuffer,
		...
		if (DataClayDeserializationLib.DEBUG_ENABLED) { 
			DataClayDeserializationLib.LOGGER.debug("[Deserialization] --> Character deserialized: data="+  charObject + ", readerindex=" + dcBuffer.readerIndex());
		}
	}

...
public final class DoubleWrapper extends DataClayJavaWrapper {
	...
	public void serialize(final DataClayByteBuffer dcBuffer, final boolean ignoreUserTypes,
		...
		if (DataClaySerializationLib.DEBUG_ENABLED) { 
			DataClaySerializationLib.LOGGER.debug("[Serialization] --> Serialized Double: data=" + doubleObject + ", writerIndex=" + dcBuffer.writerIndex());
		}
	}
	...
	public void deserialize(final DataClayByteBuffer dcBuffer,
		...
		if (DataClayDeserializationLib.DEBUG_ENABLED) { 
			DataClayDeserializationLib.LOGGER.debug("[Deserialization] --> Double deserialized: data="+  doubleObject + ", readerindex=" + dcBuffer.readerIndex());
		}
	}
